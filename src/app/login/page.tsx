      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400">
            Continúa tu búsqueda de empleo automatizada
          </p>
        </div>
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-zinc-900/50 text-zinc-500">o continúa con</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              disabled={isSubmitting}
              className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-zinc-700 text-white font-medium hover:bg-zinc-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
